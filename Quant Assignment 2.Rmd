...
paste("The sample mean for median income is $",
      prettyNum(income_summary["Mean"], digits=3))

paste("The sample median for median income is $",
      prettyNum(income_summary["Median"], digits=3))
...
paste("The sample interquartile range for median income is $",
      prettyNum(income_summary["1st Qu."], digits=5),"to $", 
      prettyNum(income_summary["3rd Qu."], digits=5))
```
...
summary_table <- tibble(
  ...
  `Percent households without internet` = c(paste(prettyNum(no_internet_summary["Mean"]*100, digits=3),"%"),
  ...
  `Median income` =  
c(prettyNum(income_summary["Mean"], digits=3), 
  prettyNum(income_summary["Median"], digits=3),
  prettyNum(income_sd, digits = 3),
  paste(prettyNum(income_summary["1st Qu."], digits=5),"to", 
        prettyNum(income_summary["3rd Qu."], digits=5)),
  paste(prettyNum(income_conf_int$conf.int[1], digits=3), "to",
        prettyNum(income_conf_int$conf.int[2], digits=3))),
...
ggplot(tract_data, aes(x = med_incomeE)) + 
  ...
  annotate("text", x = 70000, y = 35, size = 3, 
           label = paste("Population mean (95% confidence):",
                         prettyNum(income_conf_int$conf.int[1], digits=3), "to",
                         prettyNum(income_conf_int$conf.int[2], digits=3),
                         "\nSample mean:", 
                         prettyNum(income_summary["Mean"], digits=3),
                         "\nSample median:",
...
solano <- t.test(tract_data$county == "Sonano")
