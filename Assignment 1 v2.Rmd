...
I explored all three levels of data tables from the 2018 ACS 5-Year Estimates to understand the variables available.
...
I decided to conduct a census-tract level analysis in the nine-county SF Bay Area to explore internet access trends.

Unit of analysis: census-tract

  1. Bay Area county (categorical) : bayarea_county
...
Once I brought in all variables that I need for calculations, I calculated the variables I would need in my analysis (majority race/ethnicity, whether the majority of units were rented, and percent of households with no internet access).
...
Next, I loaded the data table to test the results.
